...
const byCategory: Record<string, { points: number; clue: string; answer: string }[]> = {
  "The Road to June 1984": [
    { points: 100, clue: "This peaceful protest movement launched in 1982 by Sant Jarnail Singh Ji Bhindranwale who demanded implementation of the Anandpur Sahib Resolution", answer: "What is the Dharam Yudh Morcha?" },
  ...
  "Operation Blue Star Day by Day": [
    ...
    { points: 300, clue: "The attack on June 4th was poorly timed because this religious occasion had brought nearly 10000 pilgrims to the complex", answer: "What is Guru Arjan Dev Ji's Gurpurab??" },
  ...
  "Eyewitness Accounts": [
    ...
    { points: 300, clue: "A young college girl trapped in the complex described seeing these sacred items flying through the air during the assault on the Akal Takhat", answer: "What are angs of the Guru Granth Sahib?" },
    { points: 400, clue: "The Government White Paper claimed no fire was directed at Harmandir Sahib but this Guru had bullet wounds", answer: "Who is Guru Granth Sahib Ji?" },
  ...
  "Myths vs Facts": [
    { points: 100, clue: "The government claimed the attack was last-minute and unplanned but the army had done this as early as 1982 to prepare", answer: "What is the model of the Golden Temple that the Indian army used for?" },
